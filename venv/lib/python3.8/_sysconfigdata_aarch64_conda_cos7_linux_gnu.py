...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'aarch64-conda_cos7-linux-gnu-gcc -pthread -shared -Wl,-O2 '
              ...
              '-Wl,-rpath,/config/workspace/venv/lib '
 ...
 'CONFIGURE_LDFLAGS': '-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro '
                      ...
                      '-Wl,-rpath,/config/workspace/venv/lib '
                      '-L/config/workspace/venv/lib',
 'CONFIG_ARGS': "'--prefix=/config/workspace/venv' "
                ...
                "-I/config/workspace/venv/include' "
                "'CPP=/config/workspace/venv/bin/aarch64-conda_cos7-linux-gnu-cpp' "
 ...
 'LIBFFI_INCLUDEDIR': '/config/workspace/venv/include',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/config/workspace/venv/lib/pkgconfig',
 'LIBPL':
     '/config/workspace/venv/lib/python3.8/config-3.8-aarch64-linux-gnu',
 ...
 'OPENSSL_INCLUDES': '-I/config/workspace/venv/include',
 'OPENSSL_LDFLAGS': '-L/config/workspace/venv/lib',
